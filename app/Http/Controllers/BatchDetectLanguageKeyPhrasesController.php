...
class BatchDetectLanguageKeyPhrasesController extends Controller
{
    public function DetectLanguageKeyPhrases(Request $request)
    {
        ...
        foreach ($res['documents'][0]['keyPhrases'] as &$language) {
