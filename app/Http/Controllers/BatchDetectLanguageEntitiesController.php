...
class BatchDetectLanguageEntitiesController extends Controller
{
    public function DetectLanguageEntities(Request $request)
    {
        ...
        foreach ($res['documents'][0]['entities'] as &$language) {
