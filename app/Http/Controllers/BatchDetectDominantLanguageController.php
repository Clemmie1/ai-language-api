...
class BatchDetectDominantLanguageController extends Controller
{
    public function DetectDominantLanguage(Request $request)
    {
        ...
        foreach ($res['documents'][0]['languages'] as &$language) {
